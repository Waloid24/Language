...
{
    FILE * logfile = fopen ("./logs/logsCpu/logCpu.txt", "a");
...
void cpu (int * code, size_t nStrs, size_t numTags, FILE * binFile)
{
    ...
    FILE * logfile = open_logfile ("./logs/logsStack/stack_log.txt");
    FILE * logCallStack = open_logfile ("./logs/logsStack/callStack.txt");
